...
public class bneg_blood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bneg_blood);
        ...
        reference.child("B-").child("Mymensingh").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("B-").child("Khulna").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("B-").child("Barishal").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("B-").child("Sylet").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("B-").child("Chattagram").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("B-").child("Dinajpur").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("B-").child("Rajshahi").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
