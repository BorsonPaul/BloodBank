...
public class FindBloodDonner_A_pls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_blood_donner);
        ...
        adapter1=new Adapter_class(list1,FindBloodDonner_A_pls.this);
        recycle_dhaka.setAdapter(adapter1);
        list2=new ArrayList<notice_data>();
        adapter2=new Adapter_class(list2,FindBloodDonner_A_pls.this);
        recycle_mym.setAdapter(adapter2);
        list3=new ArrayList<notice_data>();
        adapter3=new Adapter_class(list3,FindBloodDonner_A_pls.this);
        recycle_khul.setAdapter(adapter3);
        list4=new ArrayList<notice_data>();
        adapter4=new Adapter_class(list4,FindBloodDonner_A_pls.this);
        recycle_bar.setAdapter(adapter4);
        list5=new ArrayList<notice_data>();
        adapter5=new Adapter_class(list5,FindBloodDonner_A_pls.this);
        recycle_syl.setAdapter(adapter5);
        list6=new ArrayList<notice_data>();
        adapter6=new Adapter_class(list6,FindBloodDonner_A_pls.this);
        recycle_ctg.setAdapter(adapter6);
        list7=new ArrayList<notice_data>();
        adapter7=new Adapter_class(list7,FindBloodDonner_A_pls.this);
        recycle_dij.setAdapter(adapter7);
        list8=new ArrayList<notice_data>();
        adapter8=new Adapter_class(list8,FindBloodDonner_A_pls.this);
        recycle_raj.setAdapter(adapter8);
        reference.child("A+").child("Dhaka").addChildEventListener(new ChildEventListener() {
            @Override
        ...
        reference.child("A+").child("Mymensingh").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("A+").child("Khulna").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("A+").child("Barishal").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("A+").child("Sylet").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("A+").child("Chattagram").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("A+").child("Dinajpur").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("A+").child("Rajshahi").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
