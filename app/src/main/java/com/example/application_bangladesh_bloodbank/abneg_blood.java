...
public class abneg_blood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abneg_blood);
        ...
        reference.child("AB-").child("Mymensingh").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("AB-").child("Khulna").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("AB-").child("Barishal").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("AB-").child("Sylet").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("AB-").child("Chattagram").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("AB-").child("Dinajpur").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
        ...
        reference.child("AB-").child("Rajshahi").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                notice_data studentModel = snapshot.getValue(notice_data.class);
